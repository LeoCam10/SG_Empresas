...
class Ventana_eliminar_empresa(QMainWindow):
    def __init__(self):
        super().__init__()
        
        self.setWindowTitle('Ventana eliminar empresa')
        ...
        self.ingreso_habilitacion_empresa = QGroupBox()
       ...
       # self.ingreso_nombre_empresa.setPlaceholderText('Ingrese el nombre ')
        ...
        self.ingreso_tipo_empresa = QLineEdit() 
        self.ingreso_tipo_empresa.setFixedWidth(240)
        self.ingreso_tipo_empresa.setFixedHeight(40)
       ...
       # self.ingreso_dni_apoderado.setPlaceholderText('Ingrese el email ')
        ...
        self.boton_validar_ingreso = QPushButton('Eliminar',self)
